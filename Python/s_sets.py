...
print(x.difference(y), "-difference")  # this is same as diff_update, but difference returns a new set
...
zzz = {"apple"}
print(xxx.intersection(yyy, zzz), "-intersection")  # return only the same for both all
...
print(aa.isdisjoint(bb), "-isdisjoint")  # True if non of the elements is the same
...
x = {"apple", "banana", "cherry"}
y = {"google", "microsoft", "apple"}
print(x.symmetric_difference(y), "-symetric_difference")  # return all from both sets that are not the same
# just the same as above (returns a new set)

x = {"apple", "banana", "cherry"}
y = {"google", "microsoft", "apple"}
x.symmetric_difference_update(y)
print(x, "-symetric_difference_update")  # return all items from both sets that are not the same
