...
# todo: clean these tests up and add more
...
class TestFolderCrawler2(unittest.TestCase):
    def setUp(self):
        self.crawler = FolderCrawler('test_folder')
...
#
# # ----------------------------
#     def test_folder_printing_with_filter(self):
#         self.crawler._print_folders("\033[0m", "test_folder")
#         self.assertEqual(len(self.crawler.folders), 1)
#
#     def test_folder_printing_without_filter(self):
#         self.crawler._print_folders("\033[0m", "")
#         self.assertEqual(len(self.crawler.folders), 2)
#
#     def test_folder_printing_with_non_existent_filter(self):
#         self.crawler._print_folders("\033[0m", "non_existent_folder")
#         self.assertEqual(len(self.crawler.folders), 0)
